...
implements org.apache.axis2.databinding.ADBBean{
	...
	protected ray_tracer.Rectangle localSubView ;
	...
	/**
	 * Auto generated getter method
	 * @return ray_tracer.Rectangle
	 */
	public  ray_tracer.Rectangle getSubView(){
		return localSubView;
	}
	 ...
	 * @param param SubView
	 */
	public void setSubView(ray_tracer.Rectangle param){
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
					...
					if (fullTypeName!=null){
						...
						if (!"rayTraceSubView".equals(type)){
							...
							return (RayTraceSubView)ray_tracer.ExtensionMapper.getTypeObject(
									nsUri,type,reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://b534.cs.indiana.edu","camera").equals(reader.getName())){
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)){
						...
						object.setCamera(ray_tracer.CameraSetup.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://b534.cs.indiana.edu","subView").equals(reader.getName())){
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)){
						...
						object.setSubView(ray_tracer.Rectangle.Factory.parse(reader));
